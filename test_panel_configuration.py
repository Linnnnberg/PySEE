...
def test_panel_configuration():
    ...
    try:
        ...
        umap_panel.export(
            ...
            config_overrides={"font_size": 12, "line_width": 1.0, "marker_size": 5},
        )
    ...
    try:
        ...
        # Export the copy
        umap_export_copy.export(output_dir / "umap_copy.png", format="png", template="science")
    ...
    try:
        ...
        exported_files = app.export_all_panels(
            output_dir / "batch_configured", format="png", template="nature", prefix="configured"
        )
